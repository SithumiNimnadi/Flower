...
<head>
    ...
    <title>About Us - Olivia Flowers Premium Services</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-8 animate-fade-in-down">
                    ...
                    <a href="about.php" class="text-primary font-medium transition-all hover:scale-105">About</a>
            ...
            <div class="md:hidden hidden" id="mobileMenu">
                <div class="py-4 space-y-3 border-t border-gray-100 animate-fade-in-up">
                    ...
                    <a href="about.php" class="block text-primary font-medium transition-all hover:translate-x-2">About</a>
                ...
                <div class="text-center text-white">
                    <div class="animate-fade-in-down">
                        <h1 class="text-5xl md:text-7xl font-bold mb-6 leading-tight">
                            Our Story
                            <span class="block text-gradient animate-shimmer">Behind the Blooms</span>
                        </h1>
                    </div>
                    <p class="text-xl md:text-2xl mb-12 text-green-50 max-w-3xl mx-auto leading-relaxed animate-fade-in-up" style="animation-delay: 0.3s;">
                        Discover the passion, artistry, and dedication that blossoms into every Olivia Flowers creation.
                    </p>
        ...
        <section class="py-24 bg-white relative overflow-hidden">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div class="section-animate animate-fade-in-left">
                        <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Who We Are</h2>
                        <p class="text-lg text-gray-700 leading-relaxed mb-4">
                            Olivia Flowers began with a simple dream: to bring the ephemeral beauty of nature into everyday lives through exquisite floral arrangements and thoughtful decoration services. Founded by Olivia herself, a passionate florist with over two decades of experience, our journey started in a small studio and has blossomed into a beloved local institution.
                        </p>
                        <p class="text-lg text-gray-700 leading-relaxed">
                            We believe that every bloom tells a story, and every arrangement is a unique expression of emotion. From vibrant bouquets for special occasions to elegant decor for grand events, we pour our heart and soul into every creation, ensuring it reflects the beauty and sentiment you wish to convey.
                        </p>
                    </div>
                    <div class="section-animate animate-fade-in-right md:order-first">
                        <img src="https://placehold.co/600x400/8b5cf6/ffffff?text=Our+Team" alt="Our Team at Olivia Flowers" class="rounded-3xl shadow-xl w-full h-auto object-cover transform hover:scale-105 transition-transform duration-300">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-24 bg-gradient-to-b from-neutral-50 to-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-20">
                    <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6 animate-fade-in-up">Our Mission & Values</h2>
                    <p class="text-xl text-gray-600 max-w-2xl mx-auto animate-fade-in-up" style="animation-delay: 0.2s;">The principles that guide our craft and commitment to excellence</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                    <!-- Mission Card -->
                    <div class="bg-white p-8 rounded-3xl shadow-lg card-hover animate-fade-in-up stagger-animation" style="animation-delay: 0.1s;">
                        <div class="text-5xl text-accent mb-6 text-center"><i class="fas fa-lightbulb"></i></div>
                        <h3 class="text-2xl font-semibold text-gray-900 mb-4 text-center">Our Mission</h3>
                        <p class="text-gray-700 text-center">
                            To craft unforgettable floral experiences that inspire joy, celebrate life's moments, and connect people through the timeless beauty of flowers.
                        </p>
                    </div>
                    <!-- Value 1 Card -->
                    <div class="bg-white p-8 rounded-3xl shadow-lg card-hover animate-fade-in-up stagger-animation" style="animation-delay: 0.3s;">
                        <div class="text-5xl text-primary mb-6 text-center"><i class="fas fa-leaf"></i></div>
                        <h3 class="text-2xl font-semibold text-gray-900 mb-4 text-center">Quality & Freshness</h3>
                        <p class="text-gray-700 text-center">
                            We source only the freshest, highest-quality blooms, ensuring our arrangements are vibrant, long-lasting, and truly exceptional.
                        </p>
                    </div>
                    <!-- Value 2 Card -->
                    <div class="bg-white p-8 rounded-3xl shadow-lg card-hover animate-fade-in-up stagger-animation" style="animation-delay: 0.5s;">
                        <div class="text-5xl text-secondary mb-6 text-center"><i class="fas fa-heart"></i></div>
                        <h3 class="text-2xl font-semibold text-gray-900 mb-4 text-center">Passion & Creativity</h3>
                        <p class="text-gray-700 text-center">
                            Every design is infused with artistic flair and a deep love for floristry, transforming simple flowers into works of art.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="py-20 bg-gradient-to-br from-primary via-primary-dark to-accent relative overflow-hidden">
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                <div class="animate-fade-in-up">
                    <h2 class="text-4xl md:text-5xl font-bold text-white mb-6">Ready to Experience the Olivia Flowers Difference?</h2>
                    <p class="text-xl text-green-100 mb-10 leading-relaxed">
                        We invite you to explore our exquisite collections or get in touch for personalized decoration services. Let us bring your floral vision to life.
                    </p>
                </div>
            ...
            <div class="grid md:grid-cols-4 gap-12 mb-16">
                ...
                <div class="animate-fade-in-up" style="animation-delay: 0.1s;">
                    ...
                    <ul class="space-y-4">
                        ...
                        <li><a href="about.php" class="text-white transition-all hover:translate-x-2 inline-block">About</a></li>
